...
### Flags
  ...
  - `--debug` - Tells the compiler to use the debug codegenerator _(If not specified, then the production codegenerator is in use)_. Read more about [The Codegenerator](https://github.com/dr-programmer/quark/edit/develop/README.md#the-structure-of-the-quark-compiler-is-as-follows).
